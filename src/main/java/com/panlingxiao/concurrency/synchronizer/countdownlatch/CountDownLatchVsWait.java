...
/**
 * Created by panlingxiao on 2018/7/5.
 * <p>
 * http://biasedbit.com/blog/countdownlatch-vs-wait-notify/
 */
public class CountDownLatchVsWait {
    ...
    public static void main(String[] args) {
        ...
        // warmup
        runTest(new ArrayList<>(1000), 100, 10);

        // actual test
        int iterations = ITERATIONS;
        int nThreads = THREADS;
        final List<Long> times = Collections.synchronizedList(new ArrayList<Long>(nThreads * iterations));
    ...
    private static void runTest(final List<Long> times, int iterations, int nThreads) {
